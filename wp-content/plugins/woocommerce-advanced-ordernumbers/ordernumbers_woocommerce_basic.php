		...
		if ($stored_number == $this->ordernumber_new_placeholder) {
			...
			// Check whether the order was now really created => create order number now
                       ...
                       $Prefix = "";
                        ...
                        if(isset($_SESSION['myordertype']) && !empty($_SESSION['myordertype']))
                        {
                            $Prefix = $_SESSION['myordertype'];
                            unset($_SESSION['myordertype']);
                        }
                   
                    return $consumer_id.'-'.$Prefix.'-'.$this->assign_new_ordernumber($orderid, $order);
			...
			return $consumer_id.'-'.$orderprefix.'-'.$stored_number;
		} else {
