...
function azqf_form_render($name, $fields) {
    ...
    $output = '<form method="get" id="customazqfform" class="azqf-query-form ' . esc_attr(sanitize_title_with_dashes($name)) . '" data-name="' . esc_attr($name) . '" action="' . esc_url(home_url('/')) . '"><span class="toggle"></span><div class="wrapper">';
