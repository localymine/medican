 ...
 <?php do_action('azexo_entry_open'); ?>
    ...
    <?php if (isset($options[$product_template . '_show_thumbnail']) && $options[$product_template . '_show_thumbnail']): ?>
        ...
        <?php else: ?>  
            ...
            <?php endif; ?>
               <?php if (!$url):?>
    <?php $themepath =  get_stylesheet_directory_uri().'/images/imagenotavailable_lg.jpg'; ?>
    
                           <div class="entry-thumbnail customthumbnail ">
                               
                               <div class="setback"></div>
                               <div class="image owl-lazy" data-height="250" data-width="400" style="height: 250px; opacity: 1;background-image: url('<?php echo $themepath ?>')"></div>
<!--                           <div class="image owl-lazy" data-height="250" data-width="400" style="height: 250px; background-image: url("<?php // echo $themepath ?>"); opacity: 1;" data-src="<?php // echo $themepath ?>"> </div>-->
  ...
  <div class="outerentry-data">
   <div class="outerentry-data-inner">
        <div class="product_count">
           <h1 class="mycountcustom"><?php echo  $maincount = sprintf("%02d", $count);?></h1>
        </div>
        ...
        <div class="entry-header"><?php  
            ...
            ?>
                ...
                <div class="custom_metafield">
                    <ul>
                        <li> Store Domain: <?php  echo get_post_meta(get_the_ID(), 'store_domain', true );?></li>
                        <?php // $phpstring =  get_post_meta(get_the_ID(), 'store_address', true ); 
                        $address =  get_post_meta(get_the_ID(), 'store_address', true ); 
                        $wardname =  get_post_meta(get_the_ID(), 'wardName', true ); 
                        $distname =  get_post_meta(get_the_ID(), 'districtName', true ); 
                        $proviname =  get_post_meta(get_the_ID(), 'provineName', true ); 
                        $phpstring = $wardname.', '.$distname.', '.$proviname;
                        
                        
                        ?>
                        <?php 
//                        if (strlen($phpstring) > 20) {
//                      $newstring = substr($phpstring, 0, 20) . "..."; }
//                        else
//                        {
//                            $newstring = $phpstring;
//                        }
                        ?>
                       <li class="customlispan"><span class="homespan"><?php echo $address; ?></span></li><li class="secondspan"> <span class="homespanright"> <?php  echo $phpstring;?></span></li>
                    </ul>  
    ...
    <?php if (!empty($additions)) : ?>
        <!--<div class="entry-additions"><?php // print $additions; ?></div></div>-->
       <div class="entry-additions"> <?php if (!empty($footer)) : ?>
            <div class="entry-footer"><?php print $footer; ?></div>
        <?php endif; ?>
            <!--<div class="entry-more"><span>Open now</span><a class="more-link" href="">Contact</a></div>-->
       </div></div>
    <?php endif; ?>
    <?php // do_action('azexo_entry_close'); ?>
</div>
</div>
</<?php $count++; print $azexo_woo_base_tag; ?>>
<?php
