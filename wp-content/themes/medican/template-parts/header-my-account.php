    ...
    <div class="dropdown">
        ...
        <div class="link">
            <a href="<?php print ( function_exists('wc_get_page_permalink') ? esc_url(wc_get_page_permalink('myaccount')) : ''); ?>">
                <span><?php print (is_user_logged_in() ? esc_html($current_user->display_name) : esc_html__('Login/Register', 'medican')) ?></span>
            ...
            <div class="form">
                ...
                <?php if (function_exists('wc_get_page_permalink') && !azexo_is_current_post(wc_get_page_id('myaccount'))): ?>
                    ...
                    <label for="register-toggle">
                        <span class="login"><?php esc_html_e('Already have an account?', 'medican'); ?></span>
                        <span class="register"><?php esc_html_e("Don't have an account?", 'medican'); ?></span>
                    </label>
                    <?php
                ...
                <div class="social-login">
                    <label><?php esc_html_e('Connect with Social Networks:', 'medican'); ?></label> <?php print (function_exists('azsl_social_login_links') ? azsl_social_login_links() : ''); ?>
                </div>
            </div>
        <?php endif; ?>
    </div>    
