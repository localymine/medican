<div class="author-bio-wrapper">
    <div class="header">
        <h3><?php esc_html_e('About the Author', 'medican') ?></h3>
    </div>                        
    <div class="author-bio">
        <?php $options = get_option(AZEXO_THEME_NAME); echo get_avatar(get_the_author_meta('email'), isset($options['author_avatar_size']) ? $options['author_avatar_size'] : 96); ?>
