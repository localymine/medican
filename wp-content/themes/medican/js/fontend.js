...
//        initStickyMenu();
		...
		/*** Custom code added Brst **/
		
		$('.template-part').each(function(){
			$(this).attr('data-contents-per-item','1');
			$(this).attr('data-width','400');
			$(this).attr('data-height','250');
			$(this).attr('data-stagepadding','0');
			$(this).attr('data-margin','30');
			$(this).attr('data-margin','30');
			$(this).attr('data-full-width','');
			$(this).attr('data-center','');
			$(this).attr('data-loop','yes');
			var carousel = this;
			var show = initCarousel(carousel);
		});
	
		jQuery('a[href="#home-post-list"]').trigger('click');
		/*** Custom code added Brst **/
