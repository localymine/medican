...
$azexo_woo_fields = array(
    ...
    'product_thumbnail' => esc_html__('Product thumbnail', 'medican'),
    'product_gallery' => esc_html__('Product gallery', 'medican'),
    ...
    $sections[] = array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'type' => 'checkbox',
                'title' => esc_html__('Use placeholders in review form', 'medican'),
                'default' => '0',
            ),
            array(
                'id' => 'custom_sorting',
            ...
            array(
                ...
                'type' => 'checkbox',
                'title' => esc_html__('Show ratings summary', 'medican'),
                'default' => '0',
            ),
            array(
                'id' => 'review_marks',
...
function azexo_woo_tgmpa_register() {
    ...
    $plugins = array(
        array(
            'name' => esc_html__('WooCommerce', 'medican'),
            'slug' => 'woocommerce',
            'required' => true,
        ),
    );
