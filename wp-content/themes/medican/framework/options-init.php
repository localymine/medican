    ...
    class AZEXO_Redux_Framework {
        ...
        public function setSections() {
            ...
            $azexo_post_fields = array(
                ...
                'post_last_comment_author_avatar' => esc_html__('Post last comment author avatar', 'medican'),
            ...
            if (is_array($azh_widgets)) {
                foreach ($azh_widgets as $azh_widget) {
                    $azexo_fields[$azh_widget->ID] = $azh_widget->post_title . ' ' . esc_html__('AZH Widget', 'medican');
                }
            }
            ...
            $general_settings_fields[] = array(
                ...
                'type' => 'select',
                'title' => esc_html__('Single blog template', 'medican'),
            ...
            $general_settings_fields[] = array(
                ...
                'multi' => true,
                'sortable' => true,
                'title' => esc_html__('Custom dashboard pages', 'medican'),
                ...
                foreach ($post_types as $slug => $post_type) {
                    $fields = array(
                        array(
                            ...
                            'type' => 'select',
                            'title' => esc_html__('Single template', 'medican'),
                            'options' => $azexo_templates,
                            'default' => $slug,
                        ),
                        array(
                            ...
                            'type' => 'select',
                            'title' => esc_html__('Default template', 'medican'),
                            'options' => $azexo_templates,
                            'default' => $slug,
                        ),
                        array(
                        ...
                        array(
                            ...
                            'type' => 'select',
                            'multi' => true,
                            'title' => esc_html__('Show additional sidebar', 'medican'),
                            'options' => array(
                                'single' => esc_html__('Single page', 'medican'),
                                'list' => esc_html__('List page', 'medican'),
                            ),
                            'default' => '',
                        ),
                    );
                    if ($slug != 'product') {
                        $fields = array_merge($fields, array(array(
                                ...
                                'multi' => true,
                                'sortable' => true,
                                'title' => esc_html__('Before posts list', 'medican'),
                                'options' => array(
                                    'result_count' => esc_html__('Result count', 'medican'),
                                    'ordering' => esc_html__('Ordering', 'medican'),
                                ),
                                'default' => array(),
                            ),
                            array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'checkbox',
                        'title' => esc_html__('Header parts fullwidth', 'medican'),
                        'default' => '0'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'type' => 'checkbox',
                        'title' => esc_html__('Content fullwidth', 'medican'),
                        'default' => '0'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'type' => 'checkbox',
                        'title' => esc_html__('Post navigation full template', 'medican'),
                        'default' => '0'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'type' => 'select',
                        'title' => esc_html__('Before posts place', 'medican'),
                        'options' => array(
                            'inside_content_area' => esc_html__('Inside content area', 'medican'),
                            'before_container' => esc_html__('Before container', 'medican'),
                        ),
                    ...
                    array(
                        ...
                        'type' => 'multi_text',
                        'title' => esc_html__('Google font families', 'medican'),
                    ),
                    array(
                        'id' => 'templates',
                        'type' => 'multi_text',
            ...
            foreach ($azexo_templates as $template_slug => $template_name) {
                ...
                $places = array(
                    ...
                    $template_slug . '_next' => esc_html__('Append next', 'medican'),
                );
                $post_fields = array();
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array_merge(array(
                        array(
                            ...
                            'type' => 'checkbox',
                            'title' => esc_html__('Show thumbnail/gallery/video', 'medican'),
                            'default' => '1'
                        ),
                        array(
                            'id' => $template_slug . '_image_thumbnail',
                            'type' => 'checkbox',
                            'title' => esc_html__('Only image thumbnail (no gallery/video)', 'medican'),
                            'default' => '0',
            ...
            foreach ($azexo_fields as $field_slug => $field_name) {
                ...
                if (isset($taxonomy_fields[$field_slug]) || isset($meta_fields[$field_slug])) {
                    ...
                    $fields[] = array(
                        ...
                        'type' => 'checkbox',
                        'title' => esc_html__('Hide empty', 'medican'),
                        'default' => '0',
                    );
                }
                $fields[] = array(
            ...
            $theme_info .= '<p class="redux-framework-theme-data description theme-uri">' . wp_kses(__('<strong>Theme URL:</strong> ', 'medican'), array('strong' => array())) . '<a href="' . esc_url($this->theme->get('ThemeURI')) . '" target="_blank">' . $this->theme->get('ThemeURI') . '</a></p>';
            $theme_info .= '<p class="redux-framework-theme-data description theme-author">' . wp_kses(__('<strong>Author:</strong> ', 'medican'), array('strong' => array())) . $this->theme->get('Author') . '</p>';
            $theme_info .= '<p class="redux-framework-theme-data description theme-version">' . wp_kses(__('<strong>Version:</strong> ', 'medican'), array('strong' => array())) . $this->theme->get('Version') . '</p>';
            $theme_info .= '<p class="redux-framework-theme-data description theme-description">' . $this->theme->get('Description') . '</p>';
            $tabs = $this->theme->get('Tags');
            if (!empty($tabs)) {
                $theme_info .= '<p class="redux-framework-theme-data description theme-tags">' . wp_kses(__('<strong>Tags:</strong> ', 'medican'), array('strong' => array())) . implode(', ', $tabs) . '</p>';
            }
            $theme_info .= '</div>';
