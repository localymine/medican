...
class AZEXO_Dashboard_Links extends WP_Widget {
    ...
    public function form($instance) {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('visible_if_active')); ?>"><?php esc_html_e('Visible if have active link', 'medican'); ?></label><br />
        </p>
        <?php
    }
...
$azexo_widgets_visibility = array(
    'show_on_dashboard' => esc_html__('Show only on dashboard', 'medican'),
    'hide_on_dashboard' => esc_html__('Hide on dashboard', 'medican'),
    'show_on_profiles_list' => esc_html__('Show only on profiles list', 'medican'),
    'hide_on_profiles_list' => esc_html__('Hide on profiles list', 'medican'),
    'show_on_shop' => esc_html__('Show only on shop', 'medican'),
    'hide_on_shop' => esc_html__('Hide on shop', 'medican'),
);
