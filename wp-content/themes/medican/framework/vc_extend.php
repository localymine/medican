...
azexo_add_element(array(
    ...
    'params' => array(
        array(
            'type' => 'dropdown',
            'heading' => esc_html__('Template part', 'medican'),
            'param_name' => 'template_part',
            'value' => array_merge(array(esc_html__('None', 'medican') => ''), array_flip($template_parts)),
            'admin_label' => true
        ),
        array(
            'type' => 'textfield',
...
azexo_add_element(array(
    'name' => esc_html__('AZEXO - dashboard links widget', 'medican'),
    'base' => 'azexo_dashboard_links',
    'category' => esc_html__('AZEXO', 'medican'),
    'description' => esc_html__('Displays the dashboard links', 'medican'),
    'show_settings_on_create' => false,
    'params' => array(
        array(
            'type' => 'textfield',
            ...
            'value' => esc_html__('Dashboard', 'medican'),
        ),
        array(
            'type' => 'textfield',
            'heading' => esc_html__('Extra class name', 'medican'),
...
$loop_params = array(
    ...
    array(
        ...
        'value' => array(
            ...
            esc_html__('Meta value (numeric)', 'medican') => 'meta_value_num',
...
azexo_add_element(array(
    ...
    'params' => array_merge($loop_params, array(
        ...
        array(
            'type' => 'textfield',
            'heading' => esc_html__('Group by meta value', 'medican'),
            'param_name' => 'group',
            'description' => esc_html__('Enter meta key which will be used for grouping posts.', 'medican'),
        ),
        array(
            'type' => 'textfield',
