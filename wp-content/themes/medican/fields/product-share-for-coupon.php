...
<?php if (!empty($coupon)) : ?>
    <div class="share-for-coupon">
        <div class="coupon-wrapper">
            <label><?php esc_attr_e('Coupon:', 'medican'); ?></label> <span data-code="<?php print esc_attr($coupon); ?>" class="coupon" data-copied="<?php esc_attr_e('Code copied to the clipboard', 'medican'); ?>"><?php esc_attr_e('Share for view', 'medican'); ?></span>
        </div>
